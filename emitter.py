...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Monitor - Transmissão")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Monitor - Transmissão")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'message.txt', False)
